<template>
    <div :class="$style.AutomationLeavers">
 ...
 */
export interface IAutomationLeaversProps {
    description: string;
}
 ...
 */
@Component
export default class AutomationLeavers extends Vue implements IAutomationLeaversProps {
